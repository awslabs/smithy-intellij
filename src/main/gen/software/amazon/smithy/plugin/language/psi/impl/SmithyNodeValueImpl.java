...
public class SmithyNodeValueImpl extends ASTWrapperPsiElement implements SmithyNodeValue {
  ...
  @Override
  @Nullable
  public SmithyNodeArray getNodeArray() {
    return findChildByClass(SmithyNodeArray.class);
  }

  @Override
  @Nullable
  public SmithyNodeObject getNodeObject() {
    return findChildByClass(SmithyNodeObject.class);
  }

  @Override
  @Nullable
  public SmithyNodeStringValue getNodeStringValue() {
    return findChildByClass(SmithyNodeStringValue.class);
  }
  ...
  @Override
  @Nullable
  public PsiElement getNodeConstants() {
    return findChildByType(NODE_CONSTANTS);
  }
