...
public class SmithyShapeSectionImpl extends ASTWrapperPsiElement implements SmithyShapeSection {
  ...
  @Override
  @NotNull
  public List<SmithyNamespaceStatement> getNamespaceStatementList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, SmithyNamespaceStatement.class);
  }
  ...
  @Override
  @NotNull
  public SmithyUseSection getUseSection() {
    return findNotNullChildByClass(SmithyUseSection.class);
  }
