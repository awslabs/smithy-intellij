...
public class SmithyNodeObjectImpl extends ASTWrapperPsiElement implements SmithyNodeObject {
  ...
  @Override
  @NotNull
  public List<SmithyNodeObjectKvp> getNodeObjectKvpList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, SmithyNodeObjectKvp.class);
  }
