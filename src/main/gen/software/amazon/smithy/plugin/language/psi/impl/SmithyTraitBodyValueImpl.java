...
public class SmithyTraitBodyValueImpl extends ASTWrapperPsiElement implements SmithyTraitBodyValue {
  ...
  public void accept(@NotNull SmithyVisitor visitor) {
    visitor.visitTraitBodyValue(this);
  }
  ...
  public SmithyNodeValue getNodeValue() {
    return findChildByClass(SmithyNodeValue.class);
  }

  @Override
  @Nullable
  public SmithyTraitStructure getTraitStructure() {
    return findChildByClass(SmithyTraitStructure.class);
  }
