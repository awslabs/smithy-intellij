...
public class SmithyUseSectionImpl extends ASTWrapperPsiElement implements SmithyUseSection {
  ...
  @Override
  @NotNull
  public List<SmithyUseStatement> getUseStatementList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, SmithyUseStatement.class);
  }
